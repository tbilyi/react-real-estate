...
import classes from './MarketFlatDetailsItem.module.css';
import { rentIncome, GetPriceWithSpaces } from '../../shared/utility/prices';

const MarketFlatDetailsItem = ({ match, history }) => {
  ...
  const notRegistered = () => history.push('/account');
  const buyFlat = () => {
...
MarketFlatDetailsItem.propTypes = {
...
export default MarketFlatDetailsItem;
