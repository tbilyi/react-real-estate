...
import classes from './TraderPropertyDetailsItem.module.css';

const TraderPropertyDetailsItem = ({ match, history }) => {
...
TraderPropertyDetailsItem.propTypes = {
...
export default TraderPropertyDetailsItem;
